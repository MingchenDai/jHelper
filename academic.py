...
def get_list(year,semester,head,driver,session_id,request_url,default_request_parameter):
    ...
    target_list = requests.post(url=request_url + request_parameter, headers=head).json()["items"]
    return target_list
...
def get_selected_course_list(year=get_current_information()[0], semester=get_current_information()[1], driver=None,
    ...
    selected_course_list = get_list(year,semester,head,driver,session_id,request_url,request_parameter)
...
def get_exam_list(year=get_current_information()[0], semester=get_current_information()[1], driver=None,
    ...
    exam_list = get_list(year,semester,head,driver,session_id,request_url,request_parameter)
    return exam_list
...
def get_score_list(year=get_current_information()[0], semester=get_current_information()[1], driver=None,
    ...
    score_list = get_list(year,semester,head,driver,session_id,request_url,request_parameter)
    return score_list


def get_ongoing_course_list(year=get_current_information()[0], semester=get_current_information()[1], driver=None,
                            session_id=None):
    head = {
        'Accept': 'application/json, text/javascript, */*; q=0.01',
        'Accept-Encoding': 'gzip, deflate, br, zstd',
    ...
    ongoing_course_list = get_list(year,semester,head,driver,session_id,request_url,request_parameter)
    return ongoing_course_list

def get_detailed_course_list():
    return